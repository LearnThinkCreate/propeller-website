/**
 * v0 by Vercel.
 * @see https://v0.dev/t/90gVsPORpVY
        ...
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex h-[60px] items-center border-b px-6">
            <Link className="flex items-center gap-2 font-semibold" href="#">
              ...
              <span className="">Drone Unlimited</span>
            </Link>
      ...
      <div className="flex flex-col">
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
          <div className="flex items-center gap-4">
            <h1 className="font-semibold text-lg md:text-xl">Drone Unlimited Licenses</h1>
          ...
          <div className="grid gap-6">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card>
                <CardHeader>
                  <CardDescription>Customers with Active Licenses</CardDescription>
                  <CardTitle>987</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardDescription>Potential Upgrade Opportunities</CardDescription>
            ...
            <div>
              <Card>
                <CardHeader>
                  <CardTitle>Customers with Active Drone Unlimited Licenses</CardTitle>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead>Shared Drones</TableHead>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          <Button size="icon" variant="outline">
                            ...
                            <span className="sr-only">Add License</span>
                          </Button>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <TableRow>
                        <TableCell className="font-medium">Wayne Enterprises</TableCell>
                        <TableCell>2</TableCell>
                        <TableCell>3</TableCell>
                        <TableCell>1</TableCell>
                        <TableCell className="text-right">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <CardTitle>Potential Upgrade Opportunities</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="font-medium">Globex Corp.</div>
                      <div className="text-gray-500 dark:text-gray-400">1 active license</div>
                      <Button size="icon" variant="outline">
                        <PlusIcon className="h-4 w-4" />
                        <span className="sr-only">Add License</span>
                      </Button>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-gray-500 dark:text-gray-400">2 active licenses, 3 license limit</div>
                      <Button size="icon" variant="outline">
                        <PlusIcon className="h-4 w-4" />
                        <span className="sr-only">Add License</span>
                      </Button>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-gray-500 dark:text-gray-400">5 active licenses, 5 license limit</div>
                      <Button size="icon" variant="outline">
                        <PlusIcon className="h-4 w-4" />
                        <span className="sr-only">Add License</span>
                      </Button>
